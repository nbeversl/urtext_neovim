...
syntax region urtextMeta start=/\w\+::/ end=/\;/ keepend contains=urtextMetaAddSelf,urtextMetaAddDescendants,urtextName,urtextSuffix,urtextMetaKey,urtextMetaAssigner
